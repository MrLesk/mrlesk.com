...
One year later I look at Backlog.md a bit differently. In the beginning it was mostly a way to help the agents remember what they were doing, and today it's just as much a way for me to understand what they are doing.
...
It's not very opinionated, and you can create your own workflows around it.
...
That made me rethink the default. At the beginning of 2026 I realized that most of the benefits of using Backlog.md via MCP could also be achieved via the CLI.
...
For a tool like this, reliability matters more than piling on features: if the task files are where humans and agents meet, people have to be able to trust them.
...
That's what the task buys me. It points me straight at the thing that matters, instead of staring at a diff and hoping I catch it.
