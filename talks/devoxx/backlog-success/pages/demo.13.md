...
```markdown {|1-6|7-27|134-150|152-245|246-315|316-347|348-368|394-530}{maxHeight:'24rem',class:'task-structure-block'}
...
<li v-click="3">
CLI commands for working with tasks
</li>
...
<li v-click="8">
Final hints & full commands list
</li>

</ul>
<div v-click="9" mt-4>
<strong>Note:</strong> add your own instructions as needed
</div>
</div>
</div>
